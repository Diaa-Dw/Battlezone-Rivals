...
namesObject.GetComponent<NickNamesScript>().healthbars[i].gameObject.GetComponent<Image>
...
namesObject.GetComponent<NickNamesScript>().names[i].text = this.GetComponent<PhotonView>
().Owner.NickName;
}
}
...
{
if (this.GetComponent<PhotonView>().Owner.NickName == namesObject.GetComponent<NickNamesScript>().names
[i].text)
{
