...
public GameObject Canvas; [HideInInspector]
...
void TimeCountDown() {
if
(this.gameObject.GetComponent<NickNamesScript>().noRespawn == false
)
{
if (seconds > 10) {
seconds
...
if
(this.gameObject.GetComponent<NickNamesScript>().teamMode == false
)
{
...
if
(this.gameObject.GetComponent<NickNamesScript>().teamMode == true
)
{
